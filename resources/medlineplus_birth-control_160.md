...
What is emergency contraception? Emergency contraception is not a regular method of birth control. But it can be used to prevent pregnancy after unprotected intercourse or if a condom breaks. There are two types:
...
What else should I know about birth control?When deciding which birth control type is right for you, there are many different factors to consider:
...
## Selected references
- Abstinence [Teenagers] — Nemours Foundation — https://kidshealth.org/en/teens/abstinence.html
- Are Condoms 100% Effective? (For Teens) [Specifics] — Nemours Foundation — https://kidshealth.org/en/teens/effective-condoms.html
- Barrier methods of birth control - series [Images, Encyclopedia] — Medical Encyclopedia — https://medlineplus.gov/ency/presentations/100107_1.htm
- Barrier Methods of Birth Control: Spermicide, Condom, Sponge, Diaphragm, and Cervical Cap [Specifics] — American College of Obstetricians and Gynecologists — https://www.acog.org/womens-health/faqs/barrier-methods-of-birth-control-spermicide-condom-sponge-diaphragm-and-cervical-cap
- Birth Control [Start Here] — Food and Drug Administration — https://www.fda.gov/consumers/womens-health-topics/birth-control
- Birth Control (Contraceptive) Pill [Teenagers] — Nemours Foundation — https://kidshealth.org/en/teens/contraception-birth.html
- Birth control - slow release methods [Patient Handouts, Encyclopedia] — Medical Encyclopedia — https://medlineplus.gov/ency/article/007555.htm
- Birth control and family planning [Patient Handouts, Encyclopedia] — Medical Encyclopedia — https://medlineplus.gov/ency/article/001946.htm
